...
def sax_generate_files(data, label, symbol_size, length):
    ...
    file_data = open('./data/'+str(symbol_size)+'_'+str(length)+'_data.txt', 'a+')
    file_label = open('./data/'+str(symbol_size)+'_'+str(length)+'_label.txt', 'a+')
    ...
    file_data.close()
    file_label.close()
    file_data = open('./data/'+str(symbol_size)+'_'+str(length)+'_test_data.txt', 'a+')
    file_label = open('./data/'+str(symbol_size)+'_'+str(length)+'_test_label.txt', 'a+')
...
if __name__ == '__main__':
    ...
    paras = paras = [(6, 10), (6, 15), (6, 20), (6, 25), (6, 30), (6, 35), (6, 40), (6, 45), (3, 25), (5, 25), (6, 25), (7, 25), (8, 25), (9, 25), (10, 25)]
    for para in paras:
        symbol_size = para[0]
        length = para[1]
