...
def generate_tree(symbol_dist, knowledge, data, label, epsilon, threshold):
    ...
    return root, levels_node, data, label, label_count
...
def process_file(train_data, train_label, times, symbol_size, epsilon, core_index, symbol_distance, test_data, test_label):
    ...
    if epsilon == 0.5:
        ...
        threshold = 100
    root, levels, data, label, label_count = generate_tree(symbol_distance, knowledge_noised, data, label, epsilon, threshold)
    
    result = label_match_with_noise(root, symbol_size, levels, data, label, epsilon, label_count, clus_num=3)
...
if __name__ == '__main__':
    ...
    for epsilon in epsilons:
        ...
        result, acc = process_file(data, label, 0, symbol_size, epsilon, 0, symbol_distance, test_data, test_label)
        ...
        # epsilon=4
        # ['cdabc', 'dabcd', 'abcdc']
        # 12.06 3.34 5.91679338202197 0.851
