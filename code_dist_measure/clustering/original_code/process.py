...
if __name__ == '__main__':
    ...
    # result = ['abcdef', 'abcded', 'edacfc', 'fedcba', 'cabdce', 'ecacfe']
    ...
    has_visited = [False for i in range(len(result))]
    new_centers = []
    ...
    # 2023
    # ['abcdef', 'abcded', 'babcde', 'dcadfc', 'ecacfe', 'fecbab']
    # 20.99 1.8299999999999998 4.74 0.6773631115895079